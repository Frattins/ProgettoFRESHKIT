        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSpeciale = table.Column<bool>(type: "bit", nullable: false),
                    Campionato = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Squadra = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DettagliOrdini", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DettagliOrdini_Maglie_MagliaId",
                        column: x => x.MagliaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DettagliOrdini_MagliaId",
